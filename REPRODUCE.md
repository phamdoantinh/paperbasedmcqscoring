...
| ------------------------ | -------------------------------------------- | -------------------------------------------------------- |
| Pretrained model weights | `Model/marker.pt, Model/info.pt, Model/answer.pt`                              | Three specialized YOLOv11m detectors        |
...
This reads images from `images/demo1/`, runs detection with `Model/marker.pt, Model/info.pt, Model/answer.pt`, and writes results to:
